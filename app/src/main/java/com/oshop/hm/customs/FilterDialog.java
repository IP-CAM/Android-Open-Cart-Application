...
import com.oshop.hm.adapters.FilterProductsAdapter;
import com.oshop.hm.models.filter_model.get_filters.FilterDetails;
import com.oshop.hm.models.filter_model.post_filters.FiltersAttributes;
import com.oshop.hm.models.filter_model.post_filters.FiltersPrice;
import com.oshop.hm.models.filter_model.post_filters.PostFilterData;
...
public abstract class FilterDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (maxPrice > 0) {
            ...
            filter_price_slider.setMaxValue(Utilities.parseArabicFloat(String.valueOf(maxPrice)));
        } else {
            filter_max_price.setText(String.valueOf(1000));
            filter_price_slider.setMaxValue(Utilities.parseArabicFloat(String.valueOf(1000)));
        }
