...
public class SplashScreen extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("android.resource://"+getPackageName()+"/"+ R.raw.star_2);
        ...
        // NEW
        ConstantValues.IS_PHONE_VERIFIED =
                getSharedPreferences("UserInfo", MODE_PRIVATE).getInt("is_number_verify", 0);
        ConstantValues.TOKEN =
                 getSharedPreferences("UserInfo", MODE_PRIVATE).getString("token", "");
