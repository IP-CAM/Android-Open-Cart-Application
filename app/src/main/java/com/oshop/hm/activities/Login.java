...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mGoogleSignInOptions = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken(getString(R.string.default_web_client_id2)) // TODO in Server
                .requestEmail()
                .build();
        ...
        facebookLoginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LoginManager.getInstance().logInWithReadPermissions(Login.this, Arrays.asList("public_profile"/*, "user_friends" deprecated*/));
            }
        });
    ...
    private void handleGoogleSignInResult(GoogleSignInResult result) {
        //Log.w("aaaaaa" , "result.getstatus"+result.getStatus());
        if (result.isSuccess()) {
            ...
            public void onResponse(Call<UserData> call, Response<UserData> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getSuccess().equalsIgnoreCase("1") || response.body().getSuccess().equalsIgnoreCase("2"))
                    {
                        ...
                        //NEW
                        editor.putInt("is_number_verify" , userDetails.getIsNumberVerify());
                        ConstantValues.IS_PHONE_VERIFIED = userDetails.getIsNumberVerify();

                        editor.putString("token",response.body().getToken());
                        ConstantValues.TOKEN = response.body().getToken();


                        //Log.w("the-token-from-response",response.body().getToken());
    ...
    private void processGoogleRegistration(GoogleSignInAccount account) {
        ...
        dialogLoader.showProgressDialog();
        //Log.w("karam_hm : : :" , "" + account.getIdToken());
        ...
        call.enqueue(new Callback<UserData>() {
            @Override
            public void onResponse(Call<UserData> call, Response<UserData> response) {
                //Log.w("karam_hm :: :: ::" , response.body().getData().toString());
                dialogLoader.hideProgressDialog();
                ...
                if (response.isSuccessful()) {
                    if (response.body().getSuccess().equalsIgnoreCase("1") || response.body().getSuccess().equalsIgnoreCase("2")) {
                        ...
                        UserDetails userDetails = response.body().getData().get(0);
                        //Log.w("karam_hm : : :" , userDetails.toString());
                        ...
                        //Log.w("karam hm :: ::  " ,"failed"+ response.body().toString());
