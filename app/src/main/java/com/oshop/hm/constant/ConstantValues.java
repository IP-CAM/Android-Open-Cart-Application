...
public class ConstantValues {
    ...
    //*********** API Base URL ********//
    //public static final String ECOMMERCE_URL = "http://192.168.1.103/karaam-new/";//"http://learnturkishfree.com/shopapp/"//192.168.1.103;
    public static final String ECOMMERCE_URL = "http://bisuraa.com/o-shop/";

    // NEW
    public static String TOKEN = "";
    public static int IS_PHONE_VERIFIED = 0;
    ...
    public static String DELIVERY_POLICY;
