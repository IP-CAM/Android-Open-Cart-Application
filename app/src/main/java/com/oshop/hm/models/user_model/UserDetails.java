...
public class UserDetails {
    ...
    @SerializedName("is_number_verify")
    @Expose
    private int isNumberVerify;
    ...
    public int getIsNumberVerify() {
        return isNumberVerify;
    }

    public void setIsNumberVerify(int isNumberVerify) {
        this.isNumberVerify = isNumberVerify;
    }
}
