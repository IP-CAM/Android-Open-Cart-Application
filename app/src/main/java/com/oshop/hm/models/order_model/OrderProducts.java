...
public class OrderProducts implements Parcelable {
    ...
    @SerializedName("orders_product_id")//@SerializedName("orders_products_id")
    @Expose
    private int ordersProductsId;
    @SerializedName("order_id")//@SerializedName("orders_id")
    @Expose
    private int ordersId;
    @SerializedName("product_id")//@SerializedName("products_id")
    @Expose
    private int productsId;
    @SerializedName("model")//@SerializedName("products_model")
    @Expose
    private String productsModel;
    @SerializedName("name")//@SerializedName("products_name")
    @Expose
    private String productsName;
    @SerializedName("price")//@SerializedName("products_price")
    @Expose
    private String productsPrice;
    @SerializedName("total")//@SerializedName("final_price")
    @Expose
    private String finalPrice;
    @SerializedName("tax")//@SerializedName("products_tax")
    @Expose
    private String productsTax;
    @SerializedName("quantity")//@SerializedName("products_quantity")
    @Expose
