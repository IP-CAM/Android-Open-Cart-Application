package com.oshop.hm.databases;
...
public class User_Cart_DB {
    ...
    public ArrayList<CartProduct> getCartItems() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                product.setProductsFinalPrice( Utilities.arabicToDecimal( cursor.getString(12) ) );
    ...
    public static void initCartInstance() {
        ...
        final String settingURL = "http://bisuraa.com/o-shop";//"http://ionicecommerce.com/testcontroller.php";
