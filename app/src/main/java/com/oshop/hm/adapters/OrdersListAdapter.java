...
import com.oshop.hm.fragments.Order_Details;
...
public class OrdersListAdapter extends RecyclerView.Adapter<OrdersListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        //New
        String orderPrice = ConstantValues.CURRENCY_SYMBOL + new DecimalFormat("#0.00").format(Utilities.parseArabicDouble(orderDetails.getOrderPrice()));

        holder.order_price.setText(orderPrice);
        try {
            ...
            float aed_price = myAppPrefsManager.getAedCurrencyRate() * Utilities.parseArabicFloat(orderDetails.getOrderPrice());
            aed_price = Utilities.round(aed_price, 2);
            holder.order_price_aed.setText(aed_symbol + aed_price);
        }catch (Exception error){
            holder.order_price_aed.setText("");
        }
        //New
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView order_id, order_product_count, order_status, order_price,order_price_aed, order_date;
        ...
        public MyViewHolder(final View itemView) {
            ...
            order_price_aed = (TextView) itemView.findViewById(R.id.order_price_aed);
