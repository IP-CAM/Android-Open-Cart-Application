...
import com.oshop.hm.fragments.Shipping_Methods;
...
public class ShippingServicesAdapter extends RecyclerView.Adapter<ShippingServicesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        try {
            ...
            float aed_price = myAppPrefsManager.getAedCurrencyRate() * Utilities.parseArabicFloat( shippingService.getRate());
            aed_price = Utilities.round(aed_price, 2);
            holder.shippingMethodCost_aed.setText(aed_symbol + aed_price);
        }catch (Exception error){
            holder.shippingMethodCost_aed.setText("");
        }
        //New
        ...
        if (shippingService.getName().equalsIgnoreCase(shipping_methods_fragment.getSelectedShippingService().getName())) {
            ...
            //New
            shipping_methods_fragment.setSelectedShippingService(shippingService);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView shippingMethodName, shippingMethodCost , shippingMethodCost_aed;
        ...
        public MyViewHolder(final View itemView) {
            ...
            shippingMethodCost_aed = (TextView) itemView.findViewById(R.id.shipping_method_cost_aed);
