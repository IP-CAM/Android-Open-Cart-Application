...
import com.oshop.hm.fragments.Add_Address;
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                // Request Delete Address from MY_Address fragment
                                My_Addresses.DeleteAddress(customerID, addressID, context, view);
                                // Remove Address from productList List
                                addressList.remove(holder.getAdapterPosition());
                                // after remove notify the ryclerview to changes
