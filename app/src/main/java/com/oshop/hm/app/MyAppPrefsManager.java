...
public class MyAppPrefsManager {
    ...
    private static final String AED_CURRENCY_SYMBOL = "aed_currency_symbol";
    private static final String AED_CURRENCY_RATE = "aed_currency_rate";
    ...
    public void setAedCurrencySymbol(String aedCurrencySymbol) {
        prefsEditor.putString(AED_CURRENCY_SYMBOL, aedCurrencySymbol);
        prefsEditor.commit();
    }

    public String getAedCurrencySymbol() {
        return sharedPreferences.getString(AED_CURRENCY_SYMBOL, "AED");
    }

    public void setAedCurrencyRate(float aedCurrencyRate) {
        prefsEditor.putFloat(AED_CURRENCY_RATE, aedCurrencyRate);
        prefsEditor.commit();
    }

    public Float getAedCurrencyRate() {
        return sharedPreferences.getFloat(AED_CURRENCY_RATE , 2);
    }
