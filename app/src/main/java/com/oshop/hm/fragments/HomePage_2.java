...
import com.oshop.hm.adapters.ViewPagerSimpleAdapter;
...
public class HomePage_2 extends Fragment implements BaseSliderView.OnSliderClickListener {
    ...
    private void setupCustomTabs() {
        ...
        for (int i=0;  i < allSubCategoriesList.size();  i++) {
            ...
            Glide.with(getContext()).load(ConstantValues.ECOMMERCE_URL+allSubCategoriesList.get(i).getIcon()).asBitmap().into(tabIcon2);
        ...
        for (int i=0;  i< bannerImages.size();  i++) {
            ...
            slider_covers.put
                    (
                            ...
                            ConstantValues.ECOMMERCE_URL+bannerDetails.getImage().replace(" " , "%20") // to delete spaces in image link
                    );
        }
