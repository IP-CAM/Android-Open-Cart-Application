...
import com.oshop.hm.customs.CustomScrollMapFragment;
...
public class ContactUs extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double latitude = Utilities.parseArabicDouble(appSettings.getLatitude());
        double longitude = Utilities.parseArabicDouble(appSettings.getLongitude());
