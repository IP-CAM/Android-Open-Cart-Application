...
import com.oshop.hm.adapters.ProductAdapterRemovable;
...
public class RecentlyViewed extends Fragment {
    ...
    public void RequestProductDetails(final int products_id) {
        ...
        String url ="http://192.168.1.103/karaam-new/index.php?route=api/app/products";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.w("R_V XX php $ = " ,"" + error );
            }
        }){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> postMap = new HashMap<>();
                postMap.put("page_number", ""+0);
                postMap.put("language_id", ""+ConstantValues.LANGUAGE_ID );
                postMap.put("customers_id", customerID);
                postMap.put("products_id", String.valueOf(products_id));
