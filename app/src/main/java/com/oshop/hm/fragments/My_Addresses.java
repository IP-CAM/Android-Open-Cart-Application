...
import com.oshop.hm.adapters.AddressListAdapter;
...
public class My_Addresses extends Fragment {
    ...
    public void RequestAllAddresses() {
        ...
        //String token = "Bearer " + this.getContext().getSharedPreferences("UserInfo", getContext().MODE_PRIVATE).getString("token", "");
        //Log.w("the-token-is",ConstantValues.TOKEN);
